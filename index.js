...
const { Client, GatewayIntentBits, Events, ActionRowBuilder, StringSelectMenuBuilder, EmbedBuilder } = require('discord.js');
const express = require('express');

// Automatyczne deploy-commands tylko w trybie development
...
const sentFlagPath = '/tmp/embed_sent.flag';
...
client.once(Events.ClientReady, async () => {
  ...
  const embed = new EmbedBuilder()
    ...
    .setDescription(`Wybierz metodę, aby zobaczyć dostępne opcje wymiany i prowizje.
...
${emoji.crypto} Crypto`)
  ...
  try {
    ...
    console.log('✅ Embed i menu wysłane');
  } catch (err) {
    console.error('❌ Błąd przy wysyłaniu embeda:', err);
  }
});
